...
export function AnalysisDonutChart({ allocations }: AnalysisDonutChartProps) {
  ...
  return (
    <div className="flex flex-col rounded-2xl border border-border bg-card p-5 sm:p-6 shadow-sm">
      <span className="text-lg font-bold tracking-tight text-foreground mb-4">Allocation Setup</span>
